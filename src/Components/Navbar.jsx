...
// {/* <!-- ========== HEADER ========== --> */}
// {/* <Link></Link> */}
// <header class="flex flex-wrap text-[#61892F] sm:justify-start sm:flex-nowrap z-50 w-full text-sm py-3 sm:py-0 dark:bg-slate-900">
//   <nav
//     class="relative  max-w-[85rem] w-full mx-auto h-32 px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
//     aria-label="Global">
//     <div class="flex items-center  justify-between">
//       <div
//         class="flex-none text-2xl  font-semibold dark:text-white"
//         href="#"
//         aria-label="Brand">
//         <h2 className="">CollaboraFix</h2>
//       </div>
//       <div class="sm:hidden">
//         <button
//           type="button"
...
//         <a
//           class="flex items-center gap-x-2 font-semibold text-gray-500 hover:text-blue-600 sm:border-s sm:border-gray-300 sm:my-6 sm:ps-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500"
//           href="#">
//           <svg
...
//       <span class="font-semibold whitespace-nowrap text-gray-800 border-e border-e-white/[.7] sm:border-transparent pe-4 me-4 sm:py-3.5 dark:text-white">
//         My project
//       </span>
...
//           Overview
//           <svg
//             class="hs-dropdown-open:rotate-180 flex-shrink-0 w-4 h-4 transition group-hover:text-gray-800"
//             xmlns="http://www.w3.org/2000/svg"
//             width="24"
//             height="24"
//             viewBox="0 0 24 24"
...
//         <Link
//           class="text-sm font-semibold text-blue-600 py-2 sm:py-3.5 dark:text-white dark:hover:text-white"
//           href="#">
//           Overview
//         </Link>
//         <a
//           class="text-sm font-medium text-gray-800 hover:text-blue-600 sm:border-b-2 border-b-transparent py-2 sm:py-3.5 dark:text-gray-400 dark:hover:text-white"
//           href="#">
//           Features
//         </a>
//         <a
