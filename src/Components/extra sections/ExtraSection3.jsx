...
function ExtraSection3(props) {
  return (
    <div>
      <section className="py-6 bg-neutral-200 dark:bg-gray-800 dark:text-gray-100">
        <div className="container p-4 mx-auto sm:p-10">
          ...
          <div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:grid-cols-3 lg:max-w-full">
            {/* crd 1  */}
            <div className="flex flex-col overflow-hidden bg-[#86C232] border-2 rounded-md dark:border-gray-700">
              ...
              <div className="flex flex-col items-center justify-center px-2 py-8 dark:bg-gray-900">
                ...
                <button className="px-8 py-3 mt-6 text-lg font-semibold rounded sm:mt-12 dark:bg-violet-400 bg-white dark:text-gray-900">
                  Sign up
                </button>
              </div>
            </div>
            {/* card 2 */}
            <div className="flex flex-col overflow-hidden bg-[#86C232] border-2 rounded-md dark:border-violet-400">
              <div className="flex flex-col items-center justify-center px-2 py-8 space-y-4 dark:bg-gray-800">
